...
export const DonorsSection: React.FC<DonorsSectionProps> = ({
  ...
  <div>
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
      <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Manage Donors</h3>
      <button
        onClick={onAddDonor}
      ...
      <table className="w-full min-w-max sm:min-w-0">
        <thead className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
          <tr>
            ...
            <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Phone</th>
            ...
            <th className="px-3 sm:px-6 py-3 text-left text-xs font-medium text-gray-700 dark:text-gray-300 uppercase">Total Amount</th>
        ...
        <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
          {donors.map((donor) => (
            <tr key={donor.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 border-b border-gray-200 dark:border-gray-700">
              <td className="px-3 sm:px-6 py-4 text-sm font-medium text-gray-900 dark:text-gray-100">{donor.name}</td>
              <td className="px-3 sm:px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{donor.phone}</td>
              ...
              <td className="px-3 sm:px-6 py-4 text-sm font-semibold text-green-600 dark:text-green-400">
