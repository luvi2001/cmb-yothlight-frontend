...
export const NewMembersSection: React.FC<NewMembersSectionProps> = ({
  newMembers,
  onAddMember,
  onEditMember,
  onDeleteMember,
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 gap-4">
        <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">New Members</h3>
        <button
          onClick={onAddMember}
      ...
      <div className="bg-white dark:bg-gray-900 rounded-lg shadow dark:shadow-lg overflow-x-auto border border-gray-200 dark:border-gray-800">
        <table className="w-full min-w-max sm:min-w-0">
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
            {newMembers.length === 0 ? (
              <tr>
                <td colSpan={9} className="px-3 sm:px-6 py-8 text-center text-sm text-gray-500 dark:text-gray-400">
                  No new members yet
                </td>
              </tr>
            ) : (
