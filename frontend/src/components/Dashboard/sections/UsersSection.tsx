        ...
        <tbody className="divide-y divide-gray-200">
          {users.map((user) => (
            <tr key={user.id} className="hover:bg-gray-50">
              <td className="px-3 sm:px-6 py-4 text-sm font-medium">{user.name}</td>
              <td className="px-3 sm:px-6 py-4 text-sm text-gray-600">{user.email}</td>
              <td className="px-3 sm:px-6 py-4 text-sm">
                <span className="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800">
                  {user.role}
                </span>
              </td>
              <td className="px-3 sm:px-6 py-4 text-sm text-gray-600">{user.area}</td>
              <td className="px-3 sm:px-6 py-4 text-sm">
                <span
